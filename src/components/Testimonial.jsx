            ...
            <div className="container px-6 py-12 mx-auto">
                <div className="grid items-center gap-4 xl:grid-cols-5">
                    <div className="max-w-2xl mx-auto my-8 space-y-4 text-center xl:col-span-2 xl:text-left">
                        <h2 className="text-2xl sm:text-4xl font-bold">What our customers are saying</h2>
                        <p className="text-gray-500 text-sm sm:text-base">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ex culpa porroeniti sapiente nostrum natus facilis ad temporibus?</p>
                    </div>
                                ...
                                <div className="p-6 rounded shadow-md">
                                    ...
                                    <div className="flex items-center mt-4 space-x-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm dark:text-gray-400">Someone from nowhere</p>
                                        </div>
                                    </div>
                                </div>
                                <div className="p-6 rounded shadow-md">
